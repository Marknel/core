...
class DPCode(StrEnum):
    ...
    TEMP_AROUND = "temp_around"  # Ambient air temperature
    TEMP_BOILING_C = "temp_boiling_c"
    TEMP_BOILING_F = "temp_boiling_f"
    TEMP_BOTTOM = "temp_bottom"  # Minimum configurable target temperature
    TEMP_COILER = "temp_coiler"  # Evaporator coil pipe temperature
    TEMP_CONTROLLER = "temp_controller"
    TEMP_CURRENT = "temp_current"  # Current temperature in °C
    TEMP_CURRENT_F = "temp_current_f"  # Current temperature in °F
    TEMP_EFFLUENT = "temp_effluent"  # Water temperature being output
    TEMP_INDOOR = "temp_indoor"  # Indoor temperature in °C
    TEMP_SET = "temp_set"  # Set the temperature in °C
    TEMP_SET_F = "temp_set_f"  # Set the temperature in °F
    TEMP_TOP = "temp_top"  # Maximum configurable target temperature
    TEMP_UNIT_CONVERT = "temp_unit_convert"  # Temperature unit switching
    TEMP_VALUE = "temp_value"  # Color temperature
    TEMP_VALUE_V2 = "temp_value_v2"
    TEMP_VENTING = "temp_venting"  # Exhaust gas temperature
